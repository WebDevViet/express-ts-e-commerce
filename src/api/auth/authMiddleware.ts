...
import { validateBody, validateCookies, validateHeaders } from '~/global/utils/validate.ts'
import usersServices from '../users/userService.ts'
import { AUTH_MESSAGES } from './constants/authMessage.ts'
import AuthSchemaValidations, { type AuthSchemaTypes } from './schemas/authSchemaValidation.ts'
import { USERS_MESSAGES } from '../users/constants/usersMessage.ts'
import mongoDB from '~/config/database/mongoDB.ts'
import createError from '~/global/utils/createError.ts'
